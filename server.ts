...
6. Jarum Jahit Berkas Perkara (Rp 5.000) [Kategori: Alat Jahit]
...
9. Benang Jahit Berkas Perkara (Rp 10.000) [Kategori: Alat Jahit]
...
PERINGATAN PENTING:
JANGAN PERNAH membuat item umum/gabungan seperti 'Pembelian Alat tulis kantor lainnya (Pulpen, Buku Sidang, Stapler, Binder Clip, pulsa notifikasi, arsip & konsumsi sidang)'. Setiap item harus dirinci secara terpisah dan detail per item seperti daftar di atas (termasuk Jarum dan Benang jahit berkas).
...
2. Susun tanggal transaksi SETIAP JENIS ATK secara kronologis berurutan:
   ...
   - Tahap Sidang Awal: Amplop Surat, Cetak Map Bundel A, Jarum Jahit Berkas Perkara.
   - Tahap Pemeriksaan Sidang: Pulpen Sidang, Tinta Epson (BAS), Benang Jahit Berkas Perkara, Tinta Refill Canon, Catridge, Binder Clip.
...
[
  {
    ...
    "kategori": "Kertas" | "Map" | "Tinta" | "Catridge" | "Amplop" | "Alat Jahit" | "Alat Tulis" | "Klip" | "Staples" | "Arsip",
    "jumlah": number,
